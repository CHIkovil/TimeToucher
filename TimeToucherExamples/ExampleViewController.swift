...
class ExampleViewController: UIViewController {
    ...
    lazy var timerLabel:UILabel = {
        ...
        label.font = .systemFont(ofSize: 50, weight: UIFont.Weight.bold)
    ...
    public func setup() -> ASTimeToucher {
        let mainViewWidth = view.frame.width - 70
    ...
    func createConstraintsTimerView() {
        ...
        timerView.safeAreaLayoutGuide.widthAnchor.constraint(equalToConstant: view.frame.width - 100).isActive = true
        timerView.safeAreaLayoutGuide.heightAnchor.constraint(equalToConstant: view.frame.width - 100).isActive = true
    }
    ...
    func createConstraintsTimerLabel() {
        ...
        timerLabel.safeAreaLayoutGuide.bottomAnchor.constraint(equalTo: timerView.topAnchor, constant: 50).isActive = true
